...
| -------------------- | ----: | -----: | -----: | -----: | -----: | ----: | ----: | ----: | -----: | --------: | ------: | ------: |
| Balanced Adv.RAG + FT| 0.127 |  0.216 |  0.296 |  0.228 |  0.276 | 0.877 | 0.821 | 0.848 |  0.864 |     0.164 |   0.837 |   0.864 |
...
| Model                |  BLEU | METEOR | ROUGE1 | ROUGE2 | ROUGEL | Prec. |  Rec. |    F1 | CosSim | ReasonCoh | SentSim | ParaSim |
| -------------------- | ----: | -----: | -----: | -----: | -----: | ----: | ----: | ----: | -----: | --------: | ------: | ------: |
| Balanced Adv.RAG + FT | 0.016 |  0.124 |  0.246 |  0.179 |  0.219 | 0.914 | 0.827 | 0.868 |  0.914 |     0.062 |   0.910 |   0.941 |
