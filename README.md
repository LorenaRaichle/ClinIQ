...
- **Data:** The data used for fine-tuning the model and setting up the RAG pipeline has been processed in the preprocessing files 1a_ and 1b_ and can be accessed over Huggingface (`"mkonstantinw/ClinIQ_data"`). 
- **Model:** Fine-tuned model is uploaded to Huggingface (`"mkonstantinw/ClinIQ_fine_tuned"`), the baseline model is the deepseek/coder-7b-instruct-v1.5.
...
| -------------------- | ------: | -------: | ------: | -------: | --------: | -------: |
| Balanced Adv.RAG + FT|   0.422 |    0.321 |   0.319 |    0.573 |     0.436 |    0.392 |
...
| -------------------- | ----: | -----: | -----: | -----: | -----: | ----: | ----: | ----: | -----: | --------: | ------: | ------: |
| Advanced RAG plus FT (balanced) | 0.127 |  0.216 |  0.296 |  0.228 |  0.276 | 0.877 | 0.821 | 0.848 |  0.864 |     0.164 |   0.837 |   0.864 |
...
| Model                |  BLEU | METEOR | ROUGE1 | ROUGE2 | ROUGEL | Prec. |  Rec. |    F1 | CosSim | ReasonCoh | SentSim | ParaSim |
| -------------------- | ----: | -----: | -----: | -----: | -----: | ----: | ----: | ----: | -----: | --------: | ------: | ------: |
| Advanced RAG plus FT (balanced) | 0.016 |  0.124 |  0.246 |  0.179 |  0.219 | 0.914 | 0.827 | 0.868 |  0.914 |     0.062 |   0.910 |   0.941 |
