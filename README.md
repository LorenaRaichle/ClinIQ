...
- **Data:** The data used for fine-tuning the model and setting up the RAG pipeline has been processed in the preprocessing files 1a_ and 1b_ and can be accessed over Huggingface . 
